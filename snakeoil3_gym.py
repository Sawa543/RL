...
class Client():
    def __init__(self, H=None, p=None, i=None, e=None, t=None, s=None, d=None, vision=False):
        ...
        # 0=Warm-up, 1=Qualifying 2=Race, 3=unknown <Default=3>
        self.stage = 3
        self.debug = False
        # 50steps/second
    ...
    def parse_the_command_line(self):
        try:
            (opts, args) = getopt.getopt(sys.argv[1:], 'H:p:i:m:e:t:s:dhv', ['host=', 'port=', 'id=', 'steps=',
                                        'episodes=', 'track=', 'stage=', 'debug', 'help', 'version'])
    ...
    def get_servers_input(self):
        ...
        while True:
            try:
                ...
                print('.', end=' ')
                print("意思是Waiting for data on %d.............." % self.port)
...
class ServerState():
    ...
    def fancyout(self):
        ...
        sensors = [
            ...
            # 'curLapTime','lastLapTime','damage','focus','gear','racePos',
            'stucktimer', 'fuel', 'distRaced', 'distFromStart',
            'opponents', 'wheelSpinVel', 'z', 'speedZ',
            'speedY', 'speedX', 'targetSpeed', 'rpm',
            'skid', 'slip', 'track', 'trackPos', 'angle',
            ]

        # Use this to get all sensors.
        for k in sensors:
